...
psql -h %DB_HOST% -p 5432 -U %USERNAME% -d %SCHEMA% -c "\COPY MRHIER FROM '%cd%\META\/MRHIER.RRF' WITH DELIMITER AS '|' NULL AS '';"
...
psql -h %DB_HOST% -p 5432 -U %USERNAME% -d %SCHEMA% -c "\COPY MRREL FROM '%cd%\META\MRREL.RRF' WITH DELIMITER AS '|' NULL AS '';"
psql -h %DB_HOST% -p 5432 -U %USERNAME% -d %SCHEMA% -c "\COPY MRSAB FROM '%cd%\META\MRSAB.RRF' WITH DELIMITER AS '|' NULL AS '';"
psql -h %DB_HOST% -p 5432 -U %USERNAME% -d %SCHEMA% -c "\COPY MRSAT FROM '%cd%\META\/MRSAT.RRF' WITH DELIMITER AS '|' NULL AS '';"
